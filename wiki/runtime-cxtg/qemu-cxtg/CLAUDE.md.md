...
*← [Main Index](../../index.md)* | *↗ [view source](../../../qemu-cxtg/CLAUDE.md)*
...
- Test commands (`make check`, `make check-unit`, functional tests)
- RISC-V architecture overview (key directories, extension system pattern, CSR implementation pattern)
- Architectural layers (target, accelerator, device, machine)
