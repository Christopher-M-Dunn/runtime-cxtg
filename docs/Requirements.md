...
**Note:** This is a draft as of 2026-08-13. For an up-to-date live copy, see https://riscv.atlassian.net/wiki/spaces/CCEX/pages/179240966/Requirements

**Scope — how this differs from [`Composable-Extensions.md`](Composable-Extensions.md):** That document draws its requirements solely from what is literally written into the draft spec. It is therefore much more fleshed out, and what it records are real decisions — less likely to change substantially. This document records what the TG currently *wants to achieve*, and so indicates where the spec is likely heading. Its details have not been worked out: the major technical discussions about whether a given item is impractical, or even possible, have not happened yet. Items here are subject to change.
